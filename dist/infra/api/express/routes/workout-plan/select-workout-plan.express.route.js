...
class SelectWorkoutPlanRoute {
    ...
    static create(selectWorkoutPlanService) {
        return new SelectWorkoutPlanRoute("/workout-plan/:id", route_1.HttpMethod.GET, selectWorkoutPlanService);
    }
    ;
    getHandler() {
        return (request, response) => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const result = yield this.selectWorkoutPlanService.execute(input, user);
...
exports.SelectWorkoutPlanRoute = SelectWorkoutPlanRoute;
;
