...
(0, vitest_1.describe)('ListCategoryUsecase', () => {
    (0, vitest_1.it)('deve listar Categorias sendo Usuário role ADMIN', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        (0, vitest_1.expect)(output1.name).toBe('Eletrônicos');
        (0, vitest_1.expect)(output2).toHaveProperty('id');
        (0, vitest_1.expect)(output2.name).toBe('Vídeo');
        (0, vitest_1.expect)(output3).toHaveProperty('id');
        (0, vitest_1.expect)(output3.name).toBe('Ferramentas');
    ...
    (0, vitest_1.it)('deve listar Categorias sendo Usuário role USER', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        (0, vitest_1.expect)(output3).toHaveProperty('id');
        (0, vitest_1.expect)(output3.name).toBe('Ferramentas');
        (0, vitest_1.expect)(output4).toHaveProperty('id');
        (0, vitest_1.expect)(output4.name).toBe('Nao Aparecer');
